...
final class AndXSpec extends ObjectBehavior
{
    ...
    public function it_filter_collection(): void
    {
        ...
        $this->filterCollection($playersArr)->shouldYield([$playersArr[2]]);
        $this->filterCollection($playersObj)->shouldYield([$playersObj[2]]);
    }
    ...
    public function it_is_satisfied_by(): void
    {
        ...
        $playerArrB = ['pseudo' => 'Alice', 'gender' => 'F', 'points' => 9001];

        $playersObjA = $this->createPlayer('Joe',   'M', 2500);
        $playersObjB = $this->createPlayer('Alice', 'F', 9001);
