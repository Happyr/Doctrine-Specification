 ...
 * @mixin Max
 */
final class MaxSpec extends ObjectBehavior
{
    private $field = 'foo';
    ...
    {
        $this->shouldBeAnInstanceOf(Max::class);
    }
    ...
    {
        $this->transform($qb, 'a')->shouldReturn('MAX(a.foo)');
    }
    ...
    public function it_is_transformable_distinct(QueryBuilder $qb): void
    {
        ...
        $this->transform($qb, 'a')->shouldReturn('MAX(DISTINCT a.foo)');
    }
