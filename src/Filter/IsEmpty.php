...
final class IsEmpty implements Filter, Satisfiable
{
    /**
     * @var Operand|string
     */
    ...
    public function getFilter(QueryBuilder $qb, string $context): string
    {
        ...
        return sprintf('%s IS EMPTY', $field->transform($qb, $context));
    }
    ...
    public function filterCollection(iterable $collection, ?string $context = null): iterable
    {
        ...
        foreach ($collection as $candidate) {
            if (empty($field->execute($candidate, $context))) {
                yield $candidate;
            }
        }
    }
    ...
    public function isSatisfiedBy($candidate, ?string $context = null): bool
    {
        ...
        return empty($field->execute($candidate, $context));
    }
